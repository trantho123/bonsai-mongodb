...
const DesktopNavigation = () => {
  ...
  const setProceed = authToken !== null ? true : false;
  ...
  }, [location, setProceed, setCart, setWishlistData, authToken]);
          ...
          <ul className="nav-items">
            ...
            <li className="nav-links">
              <Tooltip title='Products'>
                <NavLink to="/products">
                  <span className='nav-icon-span'>Products  <Badge badgeContent={setProceed ? wishlistData.length : 0}> <AiOutlineHeart className='nav-icon' /></Badge></span>
                </NavLink>
              </Tooltip>
            </li>
